  ...
  return (
    <>
              ...
              <AnimatePresence>
                {openDropdown === 'pdf' && (
                  <motion.div
                    ...
                    animate="visible"
                    exit="exit"
                    className="absolute top-full mt-2 w-80 rounded-[var(--radius-lg)] border border-[var(--border-light)] bg-[var(--surface-1)]/96 shadow-[var(--shadow-strong)] backdrop-blur-xl py-4 overflow-hidden"
      ...
      <button
        ...
        className="lg:hidden fixed bottom-6 z-50 rounded-full border border-[var(--border-light)] bg-[var(--surface-1)]/90 px-4 py-3 text-sm font-semibold text-[var(--text-primary)] shadow-[var(--shadow-strong)] backdrop-blur"
