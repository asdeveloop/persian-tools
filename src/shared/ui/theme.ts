...
export const components = {
  // دکمه‌ها
  button: {
    base: 'inline-flex items-center justify-center px-8 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md rounded-full',
    variants: {
      primary: `text-white bg-${colors.primary[500]} border border-${colors.primary[500]} hover:bg-${colors.primary[600]} focus:ring-${colors.primary[500]}`,
      secondary: `text-black bg-white border border-black hover:bg-gray-100 focus:ring-black`,
      success: `text-white bg-${colors.status.success} border border-${colors.status.success} hover:bg-green-700 focus:ring-green-500`,
      warning: `text-white bg-${colors.status.warning} border border-${colors.status.warning} hover:bg-amber-700 focus:ring-amber-500`,
      danger: `text-white bg-${colors.status.error} border border-${colors.status.error} hover:bg-red-700 focus:ring-red-500`,
    },
  },
  ...
  // فرم‌ها
  input: {
    base: 'w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all duration-200',
